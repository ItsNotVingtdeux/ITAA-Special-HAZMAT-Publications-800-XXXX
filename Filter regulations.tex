...
\begin{document}
	...
	The author wishes to thank lizuwubeth (xmatyo5), along with those colleagues who ensured this regulation isn't miles below standard. The author also gratefully acknowledge and appreciate the many comments from the public and private sectors whose 'thoughtful' and 'constructive' comments improved the quality and usefulness of this publication
	...
	\end{tabular}
		...
		- Section 1 provides an introduction to this document, including its background and
		purpose, and a list of acronyms used herein. \\
	...
	\section{Other}
		\subsection{Important}
			...
			https://whiteknuckle.miraheze.org/wiki/White\_Knuckle\_Wiki (bery goodies game, go play it, this is a fan-document for wuckle anyways)
\end{document}